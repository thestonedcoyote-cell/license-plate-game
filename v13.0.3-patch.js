(()=>{
  ...
  if(home){
    home.innerHTML=`
      <div class="home-hero"><h1>License Plate Game</h1><p>Road trip notebook.</p></div>
      ...
      <div class="v12-home-identify">
        <div class="v12-scribble">SAME COLORS?<br>LET'S SEE!</div><h2>IDENTIFY A PLATE</h2>
  ...
  if(nav){
    nav.innerHTML=`<button class="nav-btn active" data-screen="home"><b>⌂</b>Home</button><button class="nav-btn" data-screen="identify"><b>⌕</b>Identify</button><button class="nav-btn" data-screen="camera"><b>📷</b>Camera</button><button class="nav-btn" data-screen="collection"><b>▤</b>Collection</button><button class="nav-btn" data-screen="settings"><b>•••</b>More</button>`;
