...
await load('./data/reference-renders-v10.js');await load('./data/reference-renders-tx-v10.1.js');css('./cloud-sync.css');await load('./cloud-sync.js');css('./ui-current.css');await load('./ui-current.js');
