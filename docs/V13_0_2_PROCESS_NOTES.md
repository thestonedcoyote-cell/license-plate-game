...
- Step 5: Kept the torn edges in the standalone SVG background artwork itself rather than masking the parent DOM element.
...
- The underlying app still contains historical visual layers from earlier versions; v13.0.2 deliberately overrides them rather than attempting a risky same-day stylesheet consolidation.
